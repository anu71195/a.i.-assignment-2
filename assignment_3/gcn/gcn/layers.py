...
class GraphConvolution(Layer):
    ...
    def relprop(self, relinp, support2):
        ...
        z_1 = {}
        z_2 = {}
        # print(np.sum(relinp, axis=0))
        # print(np.sum(relinp, axis=1))
        # print(np.sum(relinp))
        # print(type(relinp))
        # print(len(relinp))
        # print(type(self.input_))
        ...
        relout = np.zeros((2708, self.input_dim))
        for k, l in z_2:
            ans = 0.0
            for val, k in z_2[(k, l)]:
                ans += float(val) * z_1[k]
            relout[k, l] = ans
        # print("Creating this 3 :")
        return relout
